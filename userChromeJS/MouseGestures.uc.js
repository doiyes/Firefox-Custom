...
(() => {
	...
	GESTURES: {
			...
			//'RU': {name: '向上滚动', cmd: () => goDoCommand('cmd_scrollPageUp')},
			//'RD': {name: '向下滚动', cmd: () => goDoCommand('cmd_scrollPageDown')},
			...
			'DU': {name: '刷新当前页面', cmd: function() {document.getElementById("Browser:Reload").doCommand();}},
