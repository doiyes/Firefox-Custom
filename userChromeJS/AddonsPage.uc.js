...
location.href.startsWith('chrome://browser/content/browser.x') && (function () {
            ...
            switch (event.type) {
                case "DOMContentLoaded":
                    ...
                    if (Config.detailView) {
                        ...
                        var detail = doc.getElementById("detail-view");
        ...
        setUrlOrPath: function (doc) {
            ...
            if (!doc.getElementById("detail-InstallURL-row")) {
                ...
                if (!!value && !!label) {
                    ...
                    doc.getElementById("detail-rows").appendChild(doc.createXULElement("row")).outerHTML = xul;
                }
            }
        },
    ...
    function ScriptAddon(aScript) {
        ...
        this.iconURL = this._script.iconURL || "chrome://mozapps/skin/extensions/category-extensions.svg";
