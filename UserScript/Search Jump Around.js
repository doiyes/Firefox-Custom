...
(function() { //var l = console.log;
    ...
    var config = get_config(CO, '1|1|150').split('|');
    for (i in config) {config[i] = Number(config[i]);}
    var nw = config[1]; // Open in new window/tab, "0" false, "1" true.
    ...
    engArr = [
        ...
        ,{on:1, name:'秘迹', icon:icons.bin, type:0, kwI:'q=', url1:'mijisou.com', url2:'', urlS:'https://mijisou.com/search?q=--keywords--'}
      ,{on:1, name:'秘迹', icon:icons.bin, type:4, kwI:'q=', url1:'mijisou.com', url2:'', urlS:'https://mijisou.com/search?q=--keywords--'}
      ,{on:1, name:'秘迹', icon:icons.bin, type:1, kwI:'q=', url1:'mijisou.com', url2:'', urlS:'https://mijisou.com/search?q=--keywords--'}
      ,{on:1, name:'秘迹', icon:icons.bin, type:2, kwI:'q=', url1:'mijisou.com', url2:'', urlS:'https://mijisou.com/search?q=--keywords--'}
      ,{on:1, name:'秘迹', icon:icons.bin, type:3, kwI:'q=', url1:'mijisou.com', url2:'', urlS:'https://mijisou.com/search?q=--keywords--'}
        ,{on:1, name:'必应', icon:icons.bin, type:0, kwI:'q=', url1:'bing.com', url2:'', urlS:'https://www.bing.com/search?q=--keywords--'}
